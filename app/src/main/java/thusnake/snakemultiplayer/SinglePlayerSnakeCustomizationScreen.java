  ...
  public SinglePlayerSnakeCustomizationScreen(Menu menu) {
    ...
    nextButton
      ...
      public void onButtonCreated() {
        this.drawables.add(new MenuItem(renderer, "next", getX() + getWidth() / 2f, getY() + 5,
      ...
      public void performAction() {
        ...
        menu.setScreen(new GameSetupScreen(menu) {
          ...
          public MenuCarousel makeCarousel() {
            return new MenuCarousel(renderer, 0, backButton.getY() - renderer.getScreenHeight(),
                                    renderer.getScreenWidth(), renderer.getScreenHeight()/2f);
          }
